      ...
      <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
        {user ? (
          <>
            ...
            <Link to="/post">
              <button className= "cursor-poi bg-white hover:bg-gray-50 text-blue-600 border-2 border-blue-200 hover:border-blue-300 px-8 py-4 rounded-full font-semibold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center gap-3 transform hover:scale-105">
